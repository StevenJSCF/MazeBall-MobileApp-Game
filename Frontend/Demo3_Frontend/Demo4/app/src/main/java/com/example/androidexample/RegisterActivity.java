...
public class RegisterActivity extends AppCompatActivity {
    ...
    private final String serverUrl = "http://nickm04@coms-309-021.class.las.iastate.edu:8080/api/account/account/post1"; // Replace with your registration API endpoint URL
