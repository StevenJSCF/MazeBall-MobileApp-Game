...
public class FriendChatActivivty extends AppCompatActivity implements WebSocketListener{
    ...
    public void onWebSocketConnectionSuccess() {
        ...
        runOnUiThread(() -> Toast.makeText(FriendChatActivivty.this, "WebSocket connected successfully", Toast.LENGTH_SHORT).show());
    }

    @Override
    public void onWebSocketConnectionFailure(Exception ex) {
        // Handle WebSocket connection failure event
        runOnUiThread(() -> Toast.makeText(FriendChatActivivty.this, "WebSocket connection failed: " + ex.getMessage(), Toast.LENGTH_LONG).show());
    }
